        ...
        if event.timerId() == self.timer.timerId():
            ...
            if BLOCK_CONTROLLER and not self.nextMove:
                ...
                if self.use_sample == "y":
                    self.nextMove = BLOCK_CONTROLLER_SAMPLE.GetNextMove(nextMove, GameStatus,BOARD_DATA.currentShape.shape)
                else:
                    self.nextMove = BLOCK_CONTROLLER.GetNextMove(nextMove, GameStatus,BOARD_DATA.currentShape.shape,self.reset_flag)
